...
export function TopClients({ data }: { data: Array<ClientTotalItem & { share?: number }> }) {
    ...
    return (
        <div className="w-full flex flex-col items-center select-none">
                    ...
                    <PieChart margin={{ top: 8, right: 56, bottom: 8, left: 56 }}>
                        ...
                        <Pie
                            ...
                            label={(props: any) => {
                                ...
                                const text = `${truncateLabel(name)} ${pct}% (${formatCurrency(value)})`;
                                return (
            ...
            <div className="mt-3 text-sm text-muted-foreground">Top Clients (YTD)</div>
        </div>
    );
}
